...
function tipsAlert() {
	var value = document.getElementById("tips").value;
	if('' != value){
		alert(value);
...
<form action="${pageContext.request.contextPath}/user/login" method="post" onsubmit="return check();">
	<input id="tips" type="hidden" value="${msg}">
						...
						<td height="99" width="27%">
							<table border="0" width="70%" id="table4">
								<tr>
									...
									<td>
										<input type="text" name="name" style="width: 100px" value=""  maxlength="25">
									</td>
								...
								<tr>
									...
									<td>
										<input type="password" name="password" style="width: 100px" value=""  maxlength="25">
									</td>
